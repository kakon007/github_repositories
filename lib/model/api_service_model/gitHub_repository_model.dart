...
//
//     final gitHubRepositoryModel = gitHubRepositoryModelFromJson(jsonString);

import 'dart:convert';

GitHubRepositoryModel gitHubRepositoryModelFromJson(String str) =>
    GitHubRepositoryModel.fromJson(json.decode(str));

String gitHubRepositoryModelToJson(GitHubRepositoryModel data) =>
